...
*/
  ...
  * @author sarahaverill
*/
  public class VerifierJdbcDAOTest {
    ...
    public void testVerifyArticle() {
        v.verifyArticle(r2);
        assertThat(r.getVerified(r2.getVerified()), samePropertyValuesAs(r2));
        assertThat(r.getVerifiedBy(r2.getVerifiedBy()), samePropertyValuesAs(r2));
